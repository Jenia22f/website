...
<style>
  ...
  .main_linaer {
    background: linear-gradient(89.71deg, #424242 0.54%, rgba(63, 63, 63, 0.11) 88.29%);
    max-height: 600px;
  }
  ...
  .main-registration {
    background: linear-gradient(104.15deg, #03001B 10.85%, #440450 87.11%);
    border-radius: 20px;
    max-width: 375px;
    height: 507px;
    margin-top: 104px;
  ...
  @media only screen and (max-width: 861px) {
    ...
    .main-logins_reg-users img {
      width: 40px;
      height: 40px;
      margin: 6px 9px;
    }

    .main-logins_reg-users_data p {
      font-family: 'Roboto', sans-serif;
      font-weight: 500;
      font-size: 15px;
      color: #474747;
    ...
    .main-logins_reg-users_data span {
      font-family: 'Open Sans', sans-serif;
      font-weight: normal;
      font-size: 12px;
      color: #6C6C6C;
